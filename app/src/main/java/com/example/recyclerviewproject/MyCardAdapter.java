...
public class MyCardAdapter extends RecyclerView.Adapter<MyCardAdapter.ViewHolder>{
    MyCardJob [] myCardJobs;
    Context context;
    public MyCardAdapter(MyCardJob[] myCardJobs,MainActivity activity) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final MyCardJob myCardJobList =myCardJobs[position];
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context,myCardJobList.getCardName(),Toast.LENGTH_SHORT).show();
            }
        });
